...
public sealed class SGE_Default : SGE_Base
{
    ...
    protected override bool GeneralGCD(out IAction act)
    {
        ...
        {
            if (Pneuma.CanUse(out act, CanUseOption.MustUse))
            {
                return true;
            }
        }
    ...
    protected override bool HealSingleAbility(out IAction act)
    {
        ...
        if (Soteria.CanUse(out act) && PartyMembers.Any(b => b.HasStatus(true, StatusID.Kardion) && b.GetHealthRatio() < 0.85f))
        {
            return true;
        }
