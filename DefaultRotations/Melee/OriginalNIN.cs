...
[SourceCode(Path = "main/GlaiveRotations/Melee/OriginalNIN.cs")]
...
public sealed class OriginalNIN : NIN_Base
{
    public override string GameVersion => "6.51";

    public override string RotationName => "Tweaked Original";

    private static INinAction _ninActionAim = null;
    private static bool InTrickAttack => TrickAttack.IsCoolingDown && !TrickAttack.ElapsedAfter(15);
    private static bool InMug => Mug.IsCoolingDown && !Mug.ElapsedAfter(20);
    ...
    protected override bool GeneralGCD(out IAction act)
    {
        ...
        if ((IsBurst && !InMug) && NoNinjutsu && !hasRaijuReady
        ...
        if (NoNinjutsu)
        {
            ...
            if (hasRaijuReady && !Player.HasStatus(true, StatusID.TenChiJin))
            {
                return false;
            }
